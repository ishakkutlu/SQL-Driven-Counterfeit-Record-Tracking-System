    ...
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                komut.CommandText = "udp_Sahtecilik_Guncelle";
                komut.Parameters.AddWithValue("@Rapor_Kodu", label9.Text);
                komut.Parameters.AddWithValue("@Rapor_Kodu_Yeni", textBox1.Text);
